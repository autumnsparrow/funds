...
privileged aspect UserOrder105DataOnDemand_Roo_DataOnDemand {
    
    declare @type: UserOrder105DataOnDemand: @Component;
    
    private Random UserOrder105DataOnDemand.rnd = new SecureRandom();
    
    private List<UserOrder105> UserOrder105DataOnDemand.data;
    
    public UserOrder105 UserOrder105DataOnDemand.getNewTransientUserOrder105(int index) {
        UserOrder105 obj = new UserOrder105();
    ...
    public void UserOrder105DataOnDemand.setCreateTime(UserOrder105 obj, int index) {
        Date createTime = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setCreateTime(createTime);
    }
    
    public void UserOrder105DataOnDemand.setFailMoney(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setFailNum(UserOrder105 obj, int index) {
        BigDecimal failNum = BigDecimal.valueOf(index);
        obj.setFailNum(failNum);
    }
    
    public void UserOrder105DataOnDemand.setGameId(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setIssueNo(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setOrderStatus(UserOrder105 obj, int index) {
        BigDecimal orderStatus = BigDecimal.valueOf(index);
        obj.setOrderStatus(orderStatus);
    }
    
    public void UserOrder105DataOnDemand.setPartnerId(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setPayType(UserOrder105 obj, int index) {
        BigDecimal payType = BigDecimal.valueOf(index);
        obj.setPayType(payType);
    }
    
    public void UserOrder105DataOnDemand.setPorderId(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setPrizeMoney(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setPrizeMoneyAfterTax(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setPrizeStatus(UserOrder105 obj, int index) {
        BigDecimal prizeStatus = BigDecimal.valueOf(index);
        obj.setPrizeStatus(prizeStatus);
    }
    
    public void UserOrder105DataOnDemand.setPrizeType(UserOrder105 obj, int index) {
        BigDecimal prizeType = BigDecimal.valueOf(index);
        obj.setPrizeType(prizeType);
    }
    
    public void UserOrder105DataOnDemand.setSucMoney(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setSucNum(UserOrder105 obj, int index) {
        BigDecimal sucNum = BigDecimal.valueOf(index);
        obj.setSucNum(sucNum);
    }
    
    public void UserOrder105DataOnDemand.setTicketNum(UserOrder105 obj, int index) {
        BigDecimal ticketNum = BigDecimal.valueOf(index);
        obj.setTicketNum(ticketNum);
    }
    
    public void UserOrder105DataOnDemand.setTotalMoney(UserOrder105 obj, int index) {
    ...
    public void UserOrder105DataOnDemand.setUserId(UserOrder105 obj, int index) {
    ...
    public UserOrder105 UserOrder105DataOnDemand.getSpecificUserOrder105(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
        ...
        UserOrder105 obj = data.get(index);
        String id = obj.getOrderId();
        return UserOrder105.findUserOrder105(id);
    }
    
    public UserOrder105 UserOrder105DataOnDemand.getRandomUserOrder105() {
        init();
        UserOrder105 obj = data.get(rnd.nextInt(data.size()));
        String id = obj.getOrderId();
        return UserOrder105.findUserOrder105(id);
    }
    
    public boolean UserOrder105DataOnDemand.modifyUserOrder105(UserOrder105 obj) {
        return false;
    }
    
    public void UserOrder105DataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = UserOrder105.findUserOrder105Entries(from, to);
        if (data == null) {
            throw new IllegalStateException("Find entries implementation for 'UserOrder105' illegally returned null");
        }
        if (!data.isEmpty()) {
            return;
        }
        
        data = new ArrayList<UserOrder105>();
        for (int i = 0; i < 10; i++) {
            UserOrder105 obj = getNewTransientUserOrder105(i);
            try {
                obj.persist();
