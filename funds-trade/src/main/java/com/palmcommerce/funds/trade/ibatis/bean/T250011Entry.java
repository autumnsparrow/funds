...
public class T250011Entry extends BasicProtocol {
	...
	public static class Request {
		...
		@ProtocolElementMetaType(sequenceId = 8, elementType = ProtocolElementType.INTEGER, maxLength = 1, minLenght = 1, enumSet = "0|")
		String chargeType;
		...
		public boolean compare(Request r) {
			return isNull(this.serialNumber).equals(isNull(r.serialNumber))
					...
					&& isNull(this.account).equals(isNull(r.account))
